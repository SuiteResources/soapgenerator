...
use SOAPGenerator\PhpSource\PhpDocComment;
use SOAPGenerator\PhpSource\PhpDocElementFactory;
use SOAPGenerator\PhpSource\PhpFunction;
use SOAPGenerator\PhpSource\PhpVariable;
